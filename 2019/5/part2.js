...
(async () => {
  ...
  const opcode = {
    ...
    3: async (intCode, position, inputMode1, inputMode2, inputMode3) => {
      process.stdout.write('INPUT: ', 'utf8');
    ...
    4: async (intCode, position, inputMode1, inputMode2, inputMode3) => {
      ...
      return [position + 2, input1];
    },
    5: async (intCode, position, inputMode1, inputMode2, inputMode3) => {
      const input1 = Number(inputMode1 === 0 ? intCode[intCode[position + 1]] : intCode[position + 1]);
      const input2 = Number(inputMode2 === 0 ? intCode[intCode[position + 2]] : intCode[position + 2]);

      const newPosition = input1 !== 0 ? input2 : position + 3;

      return [newPosition, null];
    },
    6: async (intCode, position, inputMode1, inputMode2, inputMode3) => {
      const input1 = Number(inputMode1 === 0 ? intCode[intCode[position + 1]] : intCode[position + 1]);
      const input2 = Number(inputMode2 === 0 ? intCode[intCode[position + 2]] : intCode[position + 2]);
    ...
    7: async (intCode, position, inputMode1, inputMode2, inputMode3) => {
      const input1 = Number(inputMode1 === 0 ? intCode[intCode[position + 1]] : intCode[position + 1]);
      const input2 = Number(inputMode2 === 0 ? intCode[intCode[position + 2]] : intCode[position + 2]);

      intCode[intCode[position + 3]] = Number(input1 < input2);

      return [position + 4, null];
    },
    8: async (intCode, position, inputMode1, inputMode2, inputMode3) => {
      const input1 = Number(inputMode1 === 0 ? intCode[intCode[position + 1]] : intCode[position + 1]);
      const input2 = Number(inputMode2 === 0 ? intCode[intCode[position + 2]] : intCode[position + 2]);
